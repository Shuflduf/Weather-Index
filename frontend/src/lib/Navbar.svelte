...
>
  ...
  {:else}
    <button
      class="flex bg-bg-secondary hover:bg-default transition flex-row gap-2 text-xl border-l px-4 h-full text-primary justify-center items-center cursor-pointer"
