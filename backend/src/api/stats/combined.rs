...
pub async fn aggregate_stats(
    ...
    let sum_columns = [
        ...
        (run_report::Column::Purchases, "purchases"),
        (run_report::Column::GoldPurchases, "gold_purchases"),
